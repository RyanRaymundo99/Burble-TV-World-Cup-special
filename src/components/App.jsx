          ...
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div class="flex lg:flex-row md:flex-col text-gray-300">
              <a href="https://play.google.com/store/apps/details?id=com.nathnetwork.xciptv">
                <button class="bg-gray-300 bg-opacity-20 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-800 hover:text-white focus:outline-none mr-2">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.nathnetwork.xciptv"><button class="bg-gray-300 bg-opacity-20 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-800 hover:text-white focus:outline-none mr-2">
