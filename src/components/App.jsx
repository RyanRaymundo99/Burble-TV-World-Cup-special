  ...
  return (
    <div className='apps' id="App">
      <section class="text-gray-400 app-image-bg body-font app-bg-img">
        ...
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 lg:pr-20">
            <img class="object-cover object-center rounded-2xl" alt="hero" src={Appimg}/>
        </div>
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center ">
            ...
            <div class="flex lg:flex-row sm:flex-col text-gray-300 apps-download-options">
              <a href="https://play.google.com/store/apps/details?id=com.nathnetwork.xciptv">
                <button class="bg-gray-300 bg-opacity-20 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-800 hover:text-white focus:outline-none mr-2 mb-6">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.nathnetwork.xciptv"><button class="bg-gray-300 bg-opacity-20 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-800 hover:text-white focus:outline-none mr-2 mb-6">
                <AiFillWindows class="w-8 text-gray-100 h-8" />
                <span class="ml-4 flex items-start flex-col leading-none">
                  <span class="text-xs text-gray-100 mb-1">BAIXE NA</span>
                  <span class="title-font font-medium text-gray-100">Microsoft Store</span>
                </span>
              </button>
              </a>
              <a href="https://play.google.com/store/apps/details?id=com.nathnetwork.xciptv"><button class="bg-gray-300 bg-opacity-20 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-800 hover:text-white focus:outline-none">
                <AiFillApple class="w-10 text-gray-100 h-10" />
                <span class="ml-4 flex items-start flex-col leading-none">
                  <span class="text-xs text-gray-100 mb-1">BAIXE NA</span>
                  <span class="title-font font-medium text-gray-100">Apple Store</span>
                </span>
              </button>
              </a>
            </div>
