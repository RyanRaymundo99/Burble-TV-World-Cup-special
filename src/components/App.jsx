...
function App() {
  return (
    <div className='apps' id="App">
      <section class="text-gray-400 app-image-bg body-font">
        <div class="container mx-auto flex px-5 py-22 md:flex-row flex-col items-center">
          ...
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div class="flex lg:flex-row md:flex-col text-gray-300">
              <a href="https://play.google.com/store/apps/details?id=com.nathnetwork.xciptv"><button class="bg-gray-800 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-700 hover:text-white focus:outline-none">
                ...
                <span class="ml-4 flex items-start flex-col leading-none">
                  <span class="text-xs text-gray-400 mb-1">BAIXE NA</span>
